...
public class TakeDBHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "ReceiversDB";
    ...
    public TakeDBHelper(Context context){
    ...
    public void addReceiver(String nameOfGiver, String amount, String dueDate, String phNum, byte[] img){
    ...
    public ArrayList<GiveDetails> getReceivers() {
    ...
    public void updateReceivers(GiveDetails giveDetails){
        SQLiteDatabase db = this.getWritableDatabase();
